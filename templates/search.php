...
<div class="container">
    ...
    <form id="search-form" action="search.php" method="get">
        <div style="display: flex; align-items: center; gap: 10px;">
            <label for="query" style="white-space: nowrap;">Search:</label>
            <input type="text" id="query" name="query" placeholder="Enter keywords" style=\"width: 25%; padding: 8px; font-size: 16px;\">
        </div>
    ...
    <?php
    // Display results only if filters are used or search query is present
